...
def second_epoch_check(epoch, total_epochs, has_saved_current_run):
    return epoch <= total_epochs*10 and not has_saved_current_run
...
def main():
    ...
    while first_epoch_check(epoch, total_epochs) or second_epoch_check(epoch, total_epochs, has_saved_current_run):
